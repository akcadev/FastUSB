...
class _MyAppState extends State<MyApp> {
    ...
    return Row(
      ...
      children: [
        ElevatedButton(
          ...
          onPressed: () async {
            var hasPermission = await QuickUsb.hasPermission(_deviceList![4]);
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            await QuickUsb.requestPermission(_deviceList![4]);
    ...
    return Row(
      ...
      children: [
        ElevatedButton(
          ...
          onPressed: () async {
            var openDevice = await QuickUsb.openDevice(_deviceList![4]);
  ...
  Widget _getDeviceDescription() {
    return ElevatedButton(
      ...
      onPressed: () async {
        var description =
            await QuickUsb.getDeviceDescription(_deviceList![4]);
